...
util.log = function(msg) {
	if (_logLevel <= 0) console.log(`%c${msg}`, 'color: grey');
};
util.info = function(msg) {
	if (_logLevel <= 1) console.log(`%c${msg}`, 'color: green');
};
util.warn = function(msg) {
	if (_logLevel <= 2) console.log(`%c${msg}`, 'color: orange');
};
util.crit = function(msg) {
	if (_logLevel <= 3) console.log(`%c${msg}`, 'color: red');
};
